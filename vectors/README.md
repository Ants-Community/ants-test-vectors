...
**Status:** nine packs shipped — `blake3/`, `ed25519/`, `bls12-381/`,
`ecdsa-p256/`, `ecvrf-ell2/`, `cbor-canonical/`, `pouh-blocks/`, `receipt-bag/`,
`embedding/`. Vectors land as components in
...
├── ecdsa-p256/                      # from ants-client/foundation/crypto
